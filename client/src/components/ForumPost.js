...
function ForumPost({post, userID}) {
  ...
  return (
    ...
    <Link to="/userprofile"><img src={post.user.profile_picture} style={{width: "75px", height: "75px", borderRadius: "50%", background: "white", border: "1px solid white"}} /></Link><br />
    ...
    <Link to={`/user/${post.user.username}`}><img src={post.user.profile_picture} style={{width: "75px", height: "75px", borderRadius: "50%", background: "white", border: "1px solid white"}} /></Link><br />
