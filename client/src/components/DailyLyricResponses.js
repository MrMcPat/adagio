...
function DailyLyricResponses({response, userID}) {
  ...
  return (
    ...
    <p style={{fontSize: "20px"}}><span style={{background: `${response.color}`, borderRadius: "20px", border:`3px solid rgba(26, 25, 25, 0.2)`, cursor: "default"}}>&nbsp;&nbsp;&nbsp;&nbsp;</span> {response.response}</p>
