    ...
    <div style={{textAlign: "center"}} className="music-recommendations-page">
      {userResponse ? (
        <div>
          ...
          <h3>Here are your music recommendations for today <FontAwesomeIcon className="icon" icon={faRotateBack} style={{fontSize: "25px", cursor: "pointer"}} onClick={handleRandom}/></h3>
          {hide ? (
